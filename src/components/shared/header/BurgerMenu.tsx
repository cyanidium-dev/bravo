...
export default function BurgerMenu({
  ...
  return (
    <div
      ...
      } lg:hidden container max-w-[1024px] absolute z-50 top-0 right-0 w-[100vw] h-[100dvh] pb-10 bg-white text-black
      transition duration-[1000ms] overflow-y-auto`}
    >
      <div className="sticky z-[60] top-0 left-[30px] flex items-center justify-between py-4 pr-[54px] sm:pr-[100px] bg-white">
        <Logo
