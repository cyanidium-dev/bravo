...
export default function Modal({
  ...
  return (
    <div
      ...
      } fixed left-1/2 bottom-0 transform -translate-x-1/2 transition duration-[600ms] ease-out z-50 max-h-[calc(100dvh-90px)] lg:max-h-[calc(100dvh-188px)] overflow-y-auto bg-white rounded-[16px] scrollbar scrollbar-w-[3px] scrollbar-thumb-rounded-full 
