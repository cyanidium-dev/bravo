...
export default function SecondaryButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`group relative overflow-hidden flex items-center justify-center py-3 px-4 text-14med leading-[130%] rounded-full transition duration-300 ease-out border border-current active:scale-95 
