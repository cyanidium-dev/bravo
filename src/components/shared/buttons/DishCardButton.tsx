...
export default function DishCardButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`group relative overflow-hidden flex items-center justify-center w-full py-[6px] sm:py-[10px] px-4 text-10med sm:text-12med leading-[130%] rounded-full 
